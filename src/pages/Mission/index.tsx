            ...
            <>
              ...
              <div className="w-full bg-background-main">
                ...
                <section className="w-full px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
                  <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-12 sm:mb-16">
                      <h1 className="text-text-primary mb-4 sm:mb-6">
                        Our Mission & Vision
                      </h1>
                  ...
                  <div className="max-w-7xl mx-auto">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                      <div>
                        ...
                        <p className="text-body text-text-secondary mb-4 sm:mb-6">
                        ...
                        <ul className="space-y-3 sm:space-y-4">
                          <li className="flex items-start">
                            ...
                            <span className="text-body text-text-secondary">Bridging the gap between academic theory and industry practice</span>
                          </li>
                          <li className="flex items-start">
                            <svg className="w-4 h-4 sm:w-5 sm:h-5 text-primary-background mt-1 mr-2 sm:mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                              <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                            </svg>
                            <span className="text-body text-text-secondary">Developing critical thinking and analytical skills in finance</span>
                          </li>
                          <li className="flex items-start">
                            <svg className="w-4 h-4 sm:w-5 sm:h-5 text-primary-background mt-1 mr-2 sm:mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                              <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                            </svg>
                            <span className="text-body text-text-secondary">Creating networking opportunities with industry professionals</span>
                          </li>
                          <li className="flex items-start">
                            <svg className="w-4 h-4 sm:w-5 sm:h-5 text-primary-background mt-1 mr-2 sm:mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                              <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                            </svg>
                            <span className="text-body text-text-secondary">Fostering leadership and entrepreneurial mindset</span>
                          </li>
                        </ul>
                ...
                <section className="w-full px-4 sm:px-6 lg:px-8 py-16 bg-white">
                  <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-12 sm:mb-16">
                      <h2 className="text-text-primary mb-4 sm:mb-6">Our Core Values</h2>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                      <div className="text-center p-4 sm:p-6">
                        ...
                        <h3 className="card-subtitle mb-2">Excellence</h3>
                        <p className="text-body text-text-secondary">Striving for the highest standards in everything we do</p>
                      </div>
                      <div className="text-center p-4 sm:p-6">
                        <div className="w-12 h-12 sm:w-16 sm:h-16 bg-primary-background rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                          <svg className="w-6 h-6 sm:w-8 sm:h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <h3 className="card-subtitle mb-2">Collaboration</h3>
                        <p className="text-body text-text-secondary">Building strong partnerships within our community</p>
                      </div>
                      <div className="text-center p-4 sm:p-6">
                        <div className="w-12 h-12 sm:w-16 sm:h-16 bg-primary-background rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                          <svg className="w-6 h-6 sm:w-8 sm:h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <h3 className="card-subtitle mb-2">Innovation</h3>
                        <p className="text-body text-text-secondary">Embracing new ideas and creative solutions</p>
                      </div>
                      <div className="text-center p-4 sm:p-6">
                        <div className="w-12 h-12 sm:w-16 sm:h-16 bg-primary-background rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                          <svg className="w-6 h-6 sm:w-8 sm:h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <h3 className="card-subtitle mb-2">Leadership</h3>
                        <p className="text-body text-text-secondary">Developing strong leaders for tomorrow</p>
                      </div>
                      <div className="text-center p-4 sm:p-6">
                        <div className="w-12 h-12 sm:w-16 sm:h-16 bg-primary-background rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                          <svg className="w-6 h-6 sm:w-8 sm:h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <h3 className="card-subtitle mb-2">Integrity</h3>
                        <p className="text-body text-text-secondary">Maintaining honesty and ethical standards</p>
                      </div>
                      <div className="text-center p-4 sm:p-6">
                        <div className="w-12 h-12 sm:w-16 sm:h-16 bg-primary-background rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                          <svg className="w-6 h-6 sm:w-8 sm:h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <h3 className="card-subtitle mb-2">Impact</h3>
                        <p className="text-body text-text-secondary">Creating positive change in our community</p>
                      </div>
                    </div>
                  </div>
                </section>
