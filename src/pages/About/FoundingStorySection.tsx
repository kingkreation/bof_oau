...
const FoundingStorySection = () => {
  return (
    <section className="w-full bg-background-main mt-[80px] sm:mt-[100px]">
      <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-[92px] lg:pr-[80px]">
        <div className="relative w-full">
          {/* Background Stack Container */}
          <div className="relative w-full h-[500px] sm:h-[700px] lg:h-[1180px]">
            {/* Background Overlay */}
            <div
            ...
            <img
              ...
              alt="BOF OAU Team"
              className="absolute top-0 left-[15px] sm:left-[38px] w-[95%] sm:w-[94%] h-[350px] sm:h-[500px] lg:h-[754px] object-cover"
            />
            
            {/* Content Card (positioned bottom-right as requested) */}
            <div
              className="absolute bg-background-main border border-text-primary rounded-sm p-3 sm:p-4 lg:p-[22px] overflow-auto top-[180px] sm:top-[250px] left-[10px] sm:left-[30px] lg:left-[300px] w-[90%] sm:w-[85%] lg:w-[921px] h-[350px] sm:h-[500px] lg:h-[857px]"
              style={{
