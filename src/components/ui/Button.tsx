...
const buttonClasses = cva(
  'inline-flex items-center justify-center font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed hover:opacity-90 active:scale-95 min-h-[44px] sm:min-h-[40px]',
  {
    variants: {
      variant: {
      ...
      size: {
        small: 'text-sm px-3 py-2 sm:py-1.5',
        medium: 'text-base px-4 py-3 sm:py-2',
        large: 'text-lg px-6 py-4 sm:py-3',
      },
    },
    defaultVariants: {
      variant: 'primary',
